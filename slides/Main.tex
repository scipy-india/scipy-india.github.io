...
\includegraphics[scale=0.65]{../assets/SciPy-India-logo.png}
\end{center}
\maketitle
\end{frame}
...
\begin{frame}{Our mission \and activities}
\begin{itemize}
    \item \textbf{Organise workshops, conferences, and sprints} for knowledge sharing
    ...
    \item \textbf{Annual Conference} - Planning an \textit{in-person} conference for late 2025/early 2026
\end{itemize}
\end{frame}
...
\begin{itemize}
    \item \textbf{Website}: \url{https://scipy.in}
...
\begin{center}
    ...
    \includegraphics[scale=0.3]{../assets/qr-code.png}
\end{center}
\end{frame}
...
\normalsize
Visit us at: \url{https://scipy.in}
